# -*- coding: utf-8 -*-
"""
Created on Mon Feb 19 11:19:37 2024
...
data = loadtxt('C:/LEMTA/Data/Adhesion/create SiO2/SiO2_alpha_orthogonal_cell.data', skiprows=17)
    ...
    for j in range(mult_y):
        for k in range(mult_z):
            for a in range(len(x)):
                if z[a]+z_cell*k < 15.4:    #26.45 - висока підкладка, 15.4 - низька
...
#Writing
output_file = 'C:/LEMTA/Data/SiO2/ClayFF/creation/system_configurations/WA/SiO2_base.data'
