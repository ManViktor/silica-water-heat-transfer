# -*- coding: utf-8 -*-
"""
Created on Fri Oct 17 18:48:19 2025
...
output_file = 'C:/LEMTA/Data/SiO2/ClayFF/creation/system_configurations/ITR/System_Configuration.data'
si_input = 'C:/LEMTA/Data/SiO2/ClayFF/creation/system_configurations/ITR/SiO2_base.data'
water_input = 'C:/LEMTA/Data/SiO2/ClayFF/creation/system_configurations/ITR/water.data'
...
for i in range(len(Atoms)):
    ...
    Y = new_coord[1]
    Z = new_coord[2]+171.23073501261212
    
    Atoms.append([Atoms1[:,0][i]+Atoms_len, Atoms1[:,1][i], Atoms1[:,2][i], X, Y, Z])
    
len_atoms_before_duble = len(Atoms)
