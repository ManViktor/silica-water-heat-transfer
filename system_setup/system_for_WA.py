# -*- coding: utf-8 -*-
"""
Created on Mon Feb 19 12:16:32 2024
...
width = 'narrow'  # 'wide' or 'narrow'
output_file = 'C:/LEMTA/Data/SiO2/ClayFF/creation/system_configurations/WA/System_Configuration.data'
si_input = 'C:/LEMTA/Data/SiO2/ClayFF/creation/system_configurations/WA/SiO2_base_'+width+'.data'
water_input = 'C:/LEMTA/Data/SiO2/ClayFF/creation/system_configurations/WA/water_'+width+'.data'
...
num_elements_to_exchange = 0
exchange_elements(Si_up1, Si_up2, num_elements_to_exchange)
...
#move H2O
H2O_x_shift = -min(H2O_x)+((max(Si_x)+x_pbc_dist)-(max(H2O_x)-min(H2O_x)))/2
